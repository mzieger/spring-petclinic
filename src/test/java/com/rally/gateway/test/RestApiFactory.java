...
public class RestApiFactory {
    ...
    private static final String USERNAME = "topcod3r@bogus.com";

    //Specify your Rally password
    private static final String PASSWORD = "Just4Rally";

    //Specify your Rally api key
    private static final String API_KEY = "_kJafqdHqTPyRwY4YkBDEjP0KW6PV0wjvUCbZDHZu8";
